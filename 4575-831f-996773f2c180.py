...
beatport_tack_pattern    = r'^https:\/\/www\.beatport\.com(?:\/[a-z]{2})?\/track\/[\w\-]+\/\d+(?:\?.*)?$'
beatport_abum_pattern    = r'^https:\/\/www\.beatport\.com(?:\/[a-z]{2})?\/release\/[\w\-]+\/\d+(?:\?.*)?$'
...
# Track which users currently have an active download
active_downloads = {}
state = {}
ADMIN_IDS = [616584208]
    ...
    try:
        ...
        if content_type in ["album", "playlist", "chart"]:
            ...
            caption = (
                ...
                f"<b>\U0001F4FB Genre:</b> {genre_str}\n"
                f"<b>\U0001F3F7 Label:</b> {label_str}\n"
        ...
        # TRACK MODE
            ...
            caption = (
                ...
                f"<b>\U0001F4FB Genre:</b> {genre}\n"
                f"<b>\U0001F4BD Album:</b> {album}\n"
                f"<b>\U0001F3B9 Key:</b> {key_str}\n"
                f"<b>\U0001F3F7 Label:</b> {label}\n"
